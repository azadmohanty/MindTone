...
export default async function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col md:grid md:grid-cols-[256px_1fr]">
      {/* Responsive Sidebar Overlay / Drawer */}
      <Sidebar session={session} />

      {/* Main Content Scrollpane */}
      <div className="flex-1 min-h-screen flex flex-col md:pl-0 pt-16 md:pt-0 relative overflow-hidden">
